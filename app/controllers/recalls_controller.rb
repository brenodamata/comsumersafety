class RecallsController < ApplicationController
  ...
  private
    ...
    def recall_params
      params.require(:recall).permit(:number, :date, :description, :url, :title, :consumer_contact, :last_publish_date, :number_of_units, :injuries, :hazards, :remedies, :retailers, :country, :recallable_id, :recallable_type)
    end
end
